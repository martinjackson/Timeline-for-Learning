...
## <img src="img/Visual-Studio-Code-icon.svg" width=60 /> VSCode <small>(a text editor, written in JavaScript)</small>
   Download and run the installer
   [Debian, Win10, Linux, OSX](https://code.visualstudio.com/),
